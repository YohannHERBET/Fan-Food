    ...
    <div class="container flex flex-wrap justify-between items-center mx-auto md:ml-0 md:mr-0">
      ...
      <div class="w-full md:block md:w-auto md:ml-0 md:mr-0">
        <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
          <li>
            <a href="#" class="text-lg block py-2 pr-4 pl-3 border-gray-100 hover:bg-orange-300 md:hover:bg-transparent md:border-0 text-orange-400 md:hover:text-white hover:text-black border-b border-t border-orange-300 text-center mx-20 md:mx-0 md:hover:underline hover:scale-110">Accueil</a>
          </li>
          <li>
